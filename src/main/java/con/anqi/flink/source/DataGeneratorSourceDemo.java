...
public class DataGeneratorSourceDemo {
    public static void main(String[] args) throws Exception {
         ...
         *     第四个： 返回的类型
         */
        DataGeneratorSource<String> source = new DataGeneratorSource<String>(new GeneratorFunction<Long, String>() {
            @Override
            public String map(Long s) throws Exception {
                return null;
            }
        }, 100, RateLimiterStrategy.perSecond(3), Types.STRING);
